...
public class GildedRoseParamTest {
    ...
    public static Collection<Object[]> itemsToTest(){
        return Arrays.asList(new Object[][] {
                ...
                {"Quality max of 50","foo",10,60,9,49}, //basuki is taking control
                {"Sulfuras is always 80 quality and no sell in","Sulfuras",10,50,0,80},
                {"Sulfuras negative init","Sulfuras",-20,30,0,80},
                ...
                {"Backstage more than 10 days","Backstage Passes",11,20,10,21},
                {"Backstage 10 days","Backstage Passes",10,20,9,22},
                {"Backstage 6 days","Backstage Passes",6,20,5,22},
                {"Backstage 5 days or less","Backstage Passes",5,20,4,23},
                {"Backstage 1 day","Backstage Passes",1,20,0,23},
                {"Backstage 0 days","Backstage Passes",0,20,-1,0},
                {"Backstage negative sell in","Backstage Passes",-5,0,-6,0},
                {"Backstage sell in 11 max","Backstage Passes",11,50,10,50},
                {"Backstage sell in 6 max","Backstage Passes",6,50,5,50},
                {"Backstage sell in 1 max","Backstage Passes",1,50,0,50},
                {"Backstage sell in 0 max to 0","Backstage Passes",0,50,-1,0},
